	...
	private void loadConfig(){
		...
		if(!configFile.exists()){
			try {
				...
				System.out.println("[MineBet] Impossibile creare il file di configurazione :/");
			}
		}
		try {
			readConfigData();
		} catch (FileNotFoundException e) {
			System.out.println("[MineBet] Nessun file di configurazione trovato :/");
		}
	}

	private void createDefaultCfg() throws IOException{
		System.out.print("[Minebet] Creando il file di configurazione per il primo avvio del plugin...");
		...
		System.out.println("[Minebet] File di configurazione di default creato!");
	}
