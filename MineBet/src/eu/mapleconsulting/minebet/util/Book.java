...
public class Book {
	public static ItemStack createBook(){
		...
		bookMeta.setPages("To place a bet on an event with the graphical interface, "
				+ "you have to set your default bet with /bet default <bet_amount>", 
				"Once set the bet default amount, type /bet listbets gui, a menu listing all running events will open", 
				"Each event is composed of a group of books, and each book represents an opponent you can place a bet on",
